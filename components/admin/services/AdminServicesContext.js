 ...
 * - Services list with pagination, filtering, and sorting
...
// Provider component
export function AdminServicesProvider({ children }) {
    ...
    const fetchServices = useCallback(async () => {
        ...
        if (result.success) {
            // Also get count
            const countResult = await adminService.getServicesCount(state.filters);
            dispatch({
...
export default AdminServicesContext;
