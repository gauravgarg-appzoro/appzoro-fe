...
import LocationDataTable from '../../../components/admin/country-pages/LocationDataTable';
...
const LocationDataPage = () => {
    ...
    const fetchLocations = async () => {
        ...
        try {
            const [listResult, countResult] = await Promise.all([
                adminService.getLocationData({ page, limit, search: debouncedSearch }),
                adminService.getLocationDataCount({ search: debouncedSearch }),
            ]);
            if (listResult.success) {
                setLocations(Array.isArray(listResult.data) ? listResult.data : []);
            }
    ...
    const handleDelete = async (id) => {
        if (window.confirm('Are you sure you want to delete this location?')) {
            const result = await adminService.deleteLocationData(id);
            if (result.success) {
    ...
    return (
        <AdminLayout title="Location Data">
            <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4">
                <div className="mb-3 mb-md-0">
                    <h2 className="fw-bold mb-1">Location Data</h2>
                ...
                <div className="d-flex align-items-center gap-3">
                    ...
                    <Link href="/admin/country-pages/location-data/create" passHref>
            ...
            {loading ? (
                ...
                <LocationDataTable locations={locations} onDelete={handleDelete} />
            )}
